...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <table class="bestiario-table" style="width: 100%; border-collapse: collapse;">
            ...
            <!-- grazie a xsl blabla select possiamo ottenere direttamente i file dalla directory-->
            <xsl:for-each select="bestiario/mostro">
                <!-- Così mettiamo i mostri in ordine alfabetico  -->
